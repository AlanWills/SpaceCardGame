...
namespace SpaceCardGame
{
    ...
    public class EngineBlaze : AnimatedGameObject
    {
        ...
        public EngineBlaze(Vector2 localPosition) :
            base(localPosition, "GameObjects\\Animations\\EngineBlaze")
        {
            UsesCollider = false;
        }
        ...
        private void SetUpParticleEmitter()
        {
            ...
            SmokeParticleEmitter = AddChild(new ParticleEmitter(
                ...
                Color.White, Color.White, 0.5f, 0.25f, 0.25f, new Vector2(0, Size.Y * 0.5f), "GameObjects\\Animations\\Smoke"), true, true);
        }
